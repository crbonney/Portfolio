...
box_dist_list_idx = 1
circuit_set_list = [set([box_dist_list[0][0],box_dist_list[0][1]])] # uses lists of sets to make duplicate checking easier
while (len(circuit_set_list[0]) < num_boxes):
...
# print solution
print(int(box_pos_list[box_1_idx][0])*int(box_pos_list[box_2_idx][0]))
